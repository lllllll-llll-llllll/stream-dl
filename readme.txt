...
setup:
  ...
  optional: compile stream-dl.au3 into stream-dl.exe using autoit. add stream-dl folder to your windows PATH, that way you can run it easily via command line with just "stream-dl <url> <output>"
